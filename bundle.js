...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdatePassword = function onUpdatePassword(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.updatePassword(data).then(ui.updatePasswordSuccess).catch(ui.onUpdatePasswordFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updatePasswordSuccess = function updatePasswordSuccess() /*data*/{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onAddBookCancel = function onAddBookCancel() {
	  $('.bookname').val('');
	  $('.bookdesc').val('');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdateItemsSuccess = function onUpdateItemsSuccess() /*data*/{
	  // console.log(data);
	  api.viewItems().then(onViewItemsSuccess).then($('#edit-item-modal').modal('hide')).catch(failure);
	};
	...
	var onEditClick = function onEditClick(event) {
	  ...
	  var status = document.getElementById('status' + editId).value;
	  if (status !== 'Available') {
	    $('#error-on-edit').modal('show');
	    return;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onRequestClick = function onRequestClick(event) {
	  ...
	  if (status !== 'Available') {
	    $('#search-item-error-modal').modal('show');
	    return;
	  }
	  $('.request-address').val('');
	  $('.request-date').val('');
	    ...
	    if (len > 0) {
	      for (var i = 0; i < len; i++) {
	        if (data.user_items[i].name) {
	          ...
	          txt += "<tr class='tabr'><td class='tabd'>" + data.user_items[i].name + "</td><td class='tabd'>" + data.user_items[i].description + "</td><td class='tabd'>" + data.user_items[i].user_name + "</td><td class='tabd'>" + data.user_items[i].status + "<input type='hidden' id=status" + data.user_items[i].id + " value=" + data.user_items[i].status + "></td><td class='tabd'><button class='request-items' id=" + data.user_items[i].id + ">Select</button></td></tr>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onRequestCancel = function onRequestCancel() {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "939e052becbab78d3646a4c214937eb2.png";

/***/ },
/* 36 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "7beeb43690e900dea3d7ab585e3c446c.png";
