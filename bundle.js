...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchApi = __webpack_require__(17);
	var searchUi = __webpack_require__(18);
	var edit = __webpack_require__(19);
	    ...
	    if (len > 0) {
	      for (var i = 0; i < len; i++) {
	        if (data.requests[i].name && data.requests[i].description) {
	          // txt += "<tr><td>"+data.user_items[i].name+"</td><td>"+data.user_items[i].description+"</td><td><a href='#' class='del-items' id="+data.user_items[i].id+">Edit</a></td></tr>";
	          txt += "<tr><td>" + data.requests[i].name + "</td><td>" + data.requests[i].description + "</td><td>" + data.requests[i].user_name + "</td><td>" + data.requests[i].mailing_address + "</td><td>" + data.requests[i].return_date + "</td><td><a href='#' class='accept-req' id='Accept" + data.requests[i].user_items_id + "'>Accept</a></td><td><a href='#' class='reject-req' id=" + data.requests[i].user_items_id + ">Reject</a></td></tr>";
	        }
	      }
	      if (txt !== '') {
